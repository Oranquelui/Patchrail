...
## Continuation Queue
1. Introduce real provider adapters behind the existing role-policy contract for the remaining subscription execution gaps, starting with `claude_subscription` and `codex_subscription`.
